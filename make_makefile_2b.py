...
def create_makefile(choice_dict):
    ...
    f.write(f"\t@python main.py --label_noise 0.1 --noise_sched 'decay' --batchsize 64 --epochs 250 \n")
    f.write(f"\t@python main.py --label_noise 0.1 --noise_sched 'decay' --batchsize 256 --epochs 250 \n")
