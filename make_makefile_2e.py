...
def create_makefile(choice_dict):
    ...
    f.write(f"\t@python main.py --input_gaussian_noise 0.1 --noise_sched 'decay' --batchsize 1024 \n")
    f.write(f"\t@python main.py --dataset 'MNIST' --input_gaussian_noise 0.1 --noise_sched decay --batchsize 1024 \n")
