...
def create_makefile(choice_dict):
    ...
    f.write(f"\t@python main.py --gaussian_noise 0.02 --noise_sched 'decay' --batchsize 128 --epochs 250 \n")
    f.write(f"\t@python main.py --gaussian_noise 0.02 --batchsize 128 --epochs 250 \n")
    f.write(f"\t@python main.py --gaussian_noise 0.01 --noise_sched 'decay' --batchsize 128 --epochs 250 \n")
    f.write(f"\t@python main.py --gaussian_noise 0.01 --batchsize 128 --epochs 250 \n")
    f.write(f"\t@python main.py --gaussian_noise 0.05 --noise_sched 'decay' --batchsize 128 --epochs 250 \n")
    f.write(f"\t@python main.py --gaussian_noise 0.05 --batchsize 128 --epochs 250 \n")
    f.write(f"\t@python main.py --gaussian_noise 0.1 --noise_sched 'decay' --batchsize 128 --epochs 250 \n")
    f.write(f"\t@python main.py --gaussian_noise 0.1 --batchsize 128 --epochs 250 \n")
